...
struct ContentView: View {
    ...
    @State var presentingDocumentation = false
        ...
        NavigationView {
            ...
            .toolbar {
                ToolbarItemGroup(placement: .navigationBarTrailing) {
                    ...
                    Button {
                        presentingDocumentation = true
                    } label: {
                        Image(systemName: "book.closed")
                    }
                    .popover(
                        present: $presentingDocumentation,
                        attributes: {
                            $0.position = .relative(
                                popoverAnchors: [
                                    .center
                        ...
                        DocumentationView(present: $presentingDocumentation)
